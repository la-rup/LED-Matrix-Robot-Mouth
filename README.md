...
This project illuminates a MD_MAX72XX LED dot matrix in response to audio signals in order to mimic robotic speech. The system processes `.wav` files, analyzes frequency bands, and communicates with an Arduino to control LED patterns. 
...
## Usage
1. Upload the Arduino sketch (`ROB421_Mouth_Matrix.ino`) to your board.
2. Connect the LED matrix to a digital pin (default: pin 8).
